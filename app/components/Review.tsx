...
const Review = ({ review }: PropsType) => {
    return (
        <Card classes="hover:shadow-2xl hover:border-[--darker-color]">
            <article className="flex flex-col gap-2 ">
                <div className="flex gap-3 items-center">
                    <div className="border border-[currentColor] rounded-full p-2 min-w-5 min-h-5 text-center align-middle">{getNameInitials(review.reviewerName)}</div>
